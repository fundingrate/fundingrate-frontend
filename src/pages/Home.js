...
export default p => {
  ...
  return (
    <Flex.Column width={1}>
      <Banners.Welcome height='50%'/>
      
      <Flex.Row justifyContent="space-between" mx={[4, 6]} my={[4,5]} flexWrap={['wrap', 'nowrap']}>
        <Utils.RenderObject.Prop as={Card} width={[1, 'auto']} fontSize={[2,4]} label="Alerts Processed:" value={123456789} type="number" />
        <Utils.RenderObject.Prop as={Card} width={[1, 'auto']} fontSize={[2,4]} label="Trades Executed:" value={123456789} type="number" />
        <Utils.RenderObject.Prop as={Card} width={[1, 'auto']} fontSize={[2,4]} label="Realized Profit:" value={123456789} type="money" color={'lime'} />
        <Utils.RenderObject.Prop as={Card} width={[1, 'auto']} fontSize={[2,4]} label="Public Providers:" value={332244} type="number" />
      </Flex.Row>
      
      <Flex.Column mx={[4,6,8]} my={[2, 4,6]} height="100%">
        ...
        <Banner mx={4} height="80%" src="https://cdn.chips.gg/images/ml_chart01.png" opacity={0.5} width={1/4} borderRadius="rounded"/>
        </Flex.Row>
      </Flex.Column>
    </Flex.Column>
  );
